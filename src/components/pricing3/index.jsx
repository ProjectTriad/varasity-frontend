        ...
        <>
            <div className="relative">
                ...
                <div
                    ...
                    <h2 className="font-bold text-lg pb-4">Teams</h2>
                    <h1 className="font-bold text-5xl pb-6">$9.99</h1>
                    <p className="text-gray-700 pb-6 group-hover:text-gray-400">Best Suited For: Small
                        Teams who want collaborative discussions.</p>
                    <button onClick={handleNavigation}
                        className="rounded-xl cursor-pointer border-gray-400 border-2 h-14 w-70 hover:bg-white hover:text-black focus:bg-black focus:text-white focus:border-3 focus:border-white focus:ring-2 focus:ring-black mb-7 font-bold">
                        Upgrade to Teams
                    </button>
                    ...
                    <div className="text-gray-700 text-17 list-none group-hover:text-gray-400">
                        ...
                        <li className="pb-3">Private Room upto 4 people for collaboration</li>
                        <li className="pb-3">Future Updates</li>
                    </div>
                </div>
            </div>
        </>
